...
(function() {
	...
	function showGrid() {
		var colClassName = 'col-desktop-1 col-mobile-1';
		...
		for(var i = 0; i < 12; i++) {
			...
			colDiv.setAttribute('style', 'background-color: rgba(255, 255, 255, 0.3); height: 100%;');
			gridOverlay.appendChild(colDiv);
		}
		var container = document.createElement('div');
		container.setAttribute('style', 'position: fixed; top: 0; left: 0; right: 0; bottom: 0;');
